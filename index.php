        ...
        <div class="row">
            <div class="col-3">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="insert.php" method="post" onsubmit="return validate(this)">
            ...
            <div class="col-9">
            <table class="table table-dark table-drepped">
                <thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="actualizar.php?id=<?php echo $row['id']?>" class="btn btn-primary">Editar</a></td>
